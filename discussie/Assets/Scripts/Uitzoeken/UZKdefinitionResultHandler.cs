...
[RequireComponent(typeof(BaseDefinition))]
public class UZKdefinitionResultHandler : MonoBehaviour
{
    ...
    public void StartUp()
    {
        ...
        string serverString = baseDef.results;
    ...
    private IEnumerator AnimateIn()
	{
        ...
        while (_timeValue < 1)
        {
            _timeValue += Time.deltaTime / baseDef.animateInDuration;
            float _evaluatedTimeValue = baseDef.animateInCurve.Evaluate(_timeValue);
    ...
    private IEnumerator AnimateOut()
    {
        ...
        while (_timeValue < 1)
        {
            _timeValue += Time.deltaTime / baseDef.animateOutDuration;
            float _evaluatedTimeValue = baseDef.animateOutCurve.Evaluate(_timeValue);
